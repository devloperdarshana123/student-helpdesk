        ...
        >
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 lg:gap-6 text-sm font-medium text-gray-600">
            ...
            <SignedOut>
              ...
              <Link
                href="/sign-up"
                className="px-5 py-2 rounded-full bg-gradient-to-r from-emerald-400 to-green-500 text-white text-sm shadow-md font-semibold hover:scale-105 transition-all whitespace-nowrap"
              >
                Get Started
              </Link>
            </SignedOut>
            ...
            <SignedIn>
              ...
              <Link
                href="/chat"
                className="px-4 py-2 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition flex items-center gap-1"
              >
                🤖 Chatbot
              </Link>
